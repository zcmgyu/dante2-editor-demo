...
import './App.css';
import { DanteEditor } from "Dante2/dist/Dante2";
...
// const { DanteEditor, Dante } = "Dante2";
// const {DanteEditor} = require("Dante2");
...
class MediumEditor extends Component {
    ...
    render() {
        return (
            <DanteEditor content={this.props.content} config={this.options} />
        );
    }
}
